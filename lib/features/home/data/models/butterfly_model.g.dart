...
part of 'butterfly_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ButterflyModelAdapter extends TypeAdapter<ButterflyModel> {
  @override
  final int typeId = 4;

  @override
  ButterflyModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ButterflyModel obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.path)
  ...
  bool operator ==(Object other) =>
      ...
      other is ButterflyModelAdapter &&
