...
part of 'save_butterfly_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SaveButterflyModelAdapter extends TypeAdapter<SaveButterflyModel> {
  @override
  final int typeId = 2;

  @override
  SaveButterflyModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, SaveButterflyModel obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.path)
  ...
  bool operator ==(Object other) =>
      ...
      other is SaveButterflyModelAdapter &&
